      ...
      <div class="col-md-8">
        ...
        <vuestic-widget class="" v-for="contest in contestArray" :key="contest.id">
          ...
          <div id="projects-content-div">
            ...
            <p v-show="contest.date.start"><strong>Starts on:</strong>  {{contest.date.start | moment("dddd, MMMM Do YYYY, h:mm a")}}</p>
            <p v-show="contest.date.end"><strong>Ends on: </strong> {{contest.date.end | moment("dddd, MMMM Do YYYY, h:mm a") }}</p>            
          </div>
