export default {
  'pagination': {
    ...
    'current_page': 1,
    'last_page': 2,
    'next_page_url': 'https://vuetable.ratiw.net/api/users?per_page=2&page=2',
    'prev_page_url': null,
    'from': 1,
    'to': 6
  },
  'data': [
    ...
    {
      'id': 2,
      'contestname': 'TCS Bring the future',
      'sponsor': 'Tata Consultancy Services',
      'mode': 'Online',
      'finalstatus': 'Third Prize',
      'date': '21 Nov 2017',
    ...
    {
      'id': 3,
      'contestname': 'IBM\'s Inquistic innovators',
      'sponsor': 'IBM',
      'mode': 'Offline',
